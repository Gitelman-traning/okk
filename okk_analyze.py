...
6. Для каждого ОБЯЗАТЕЛЬНОГО ЭЛЕМЕНТА (список ниже) отвечай двумя признаками:
   ...
   И к каждому элементу — "why": одно-два предложения, ПОЧЕМУ ты ответил именно так: что именно
   в разговоре засчитал, или чего именно не нашёл. Пиши так, чтобы человек, слушавший запись,
   мог согласиться или возразить.
